...
const normalTimes = ['06:00-06:30', '06:30-07:00', '07:00-07:30','07:30-08:00','08:00-08:30', '08:30-09:00', '09:00-09:30', '09:30-10:00', '10:00-10:30', '10:30-11:00', '11:00-11:30', '11:30-12:00', '12:00-12:30', '12:30-13:00', '15:00-15:30', '15:30-16:00', '16:00-16:30', '16:30-17:00', '17:00-17:30', '17:30-18:00', '18:00-18:30', '18:30-19:00', '19:00-19:30', '19:30-20:00', '20:00-20:30', '20:30-21:00', '21:00-21:30', '21:30-22:00', '22:00-22:30', '22:30-23:00'];

const extendedTimes = ['06:00-07:00', '07:00-08:00', '08:00-09:00', '09:00-10:00', '10:00-11:00', '11:00-12:00', '12:00-13:00', '15:00-16:00', '16:00-17:00', '17:00-18:00', '18:00-19:00', '19:00-20:00', '20:00-21:00', '21:00-22:00', '22:00-23:00'];
...
app.post('/check-availability', async (req, res) => {
    ...
    try {
        ...
        timesToCheck.forEach(time => {
            const startTime = new Date(`${start.split('T')[0]}T${time.split('-')[0]}:00`);
            const endTime = new Date(`${start.split('T')[0]}T${time.split('-')[1]}:00`);
            ...
            const isAvailable = !events.some(event => {
                ...
                const isEventDuringTimeSlot = (eventStart <= startTime && eventEnd >= endTime) ||
                ...
                const isSameColorOrAvailableForAnyBarber = event.colorId === barberColorId || event.colorId === '1';
        ...
        console.error('Erro ao verificar disponibilidade:', error);
        res.status(500).json({ error: 'Ocorreu um erro ao verificar a disponibilidade.' });
    }
});
